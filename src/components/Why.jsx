      ...
      <div className="min-h-45 flex flex-col  justify-center  items-center ">
        ...
        <div className="h-full w-98 flex justify-center  items-center ">
          <div className="h-full w-81  flex ">
            <div className="w-1/2  min-h-45 h-full bg-section2 bg-no-repeat hidden lg:flex"></div>
            <div className=" w-full lg:w-2/3   flex flex-wrap items-center justify-start lg:items-start gap-2">
              ...
              <img src="gain.png" alt="" className=" bg-contain w-40" />
              <img src="build.png" alt="" className=" bg-contain w-40" />
              <img src="confidence.png" alt="" className=" bg-contain w-40" />
              <img src="expand.png" alt="" className=" bg-contain w-40" />
              {/* </div> */}
            </div>
          </div>
        </div>
